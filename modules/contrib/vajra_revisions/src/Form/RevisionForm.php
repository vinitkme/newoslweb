...
namespace Drupal\vajra_revisions\Form;
...
class RevisionForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['filter_content_type'] = array(
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    if($form_state->getValue('start_date')!=null && $form_state->getValue('end_date')==null) {
        $form_state->setErrorByName('end_date', $this->t('Select a End Date'));
    }else if($form_state->getValue('end_date')!=null  && $form_state->getValue('start_date') == null) {
      $form_state->setErrorByName('start_date', $this->t('Select a Start Date'));
    }
    else if($form_state->getValue('start_date')!=null &&  $form_state->getValue('end_date')!=null && $form_state->getValue('start_date') >= $form_state->getValue('end_date')){
